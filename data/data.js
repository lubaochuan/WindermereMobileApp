...
export const data = {
  ...
  recPages: [
    ...
    },
    {
      ...
      when2:'WHEN',
      whendetail2:'Private Sessions can be scheduled all year, in advance',
      where2:'WHERE',
      wheredetail2:'Private Sessions meet at The Edge',
      how2:'HOW',
      howdetail2:'Schedule and purchase Private Sessions at Sales at least two weeks in advance',
      time2:'TIME',
      timedetail2:'Private Sessions are typically 3 to 8 hours long, but can be adjusted to meet group needs\n',
      coordinate: {
        latitude: 38.0333826,
        longitude: -92.8508212,
      }
